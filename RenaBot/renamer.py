...
# # import requests
# # link="http://images.mangafreak.net:8080/downloads/Shingeki_No_Kyojin_"
# # for i in range(1,137):
# #     link1=link+str(i)
# #     url = link1
# #     r = requests.get(url, allow_redirects=True)
# #     open('Attack on Titan Chapter'+i, 'wb').write(r.content)

# # image1 = Image.open(r'C:\Users\Lenovo\Desktop\Test\image1.png')
# # image2 = Image.open(r'C:\Users\Lenovo\Desktop\Test\image2.png')
# # im1=[]
# # im1.append(image1.convert('L'))
# # im1.append(image2.convert('L'))

# # imagelist = [im1[1]]
# # im1[0].save(r'C:\Users\Lenovo\Desktop\Test\myImages.pdf',save_all=True, append_images=imagelist)

# from typing import Type
# from config import client2 as C
